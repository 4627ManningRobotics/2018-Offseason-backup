...
public class TurnAndAddData extends Command {
    ...
    protected void initialize() {
		...
		this.c = new TurnToAngle(this.degree * 5, this.speed / 5, 3);
		this.c.start();
    }
    ...
    protected void execute() {
    	...
    	if(this.finishedTime + this.timeInterval <= System.currentTimeMillis() && this.c.isCompleted() && !this.hasJustFinished) {
			NN.addTrainDataToFile(new double[] {Robot.sensors.getGyroAngle(), this.speed / 5}, new double[] {this.degree * 5}, "/home/lvuser/Saves/turnSetSaveTest.txt");
    		this.c = new TurnToAngle(this.degree * 5, this.speed / 5, 3);
    		this.c.start();
    	}
